...
Use the standard `rails db:seed` command to seed your database with basic test users and the correct autogrant limits.
...
To run those, run `INCLUDE_ACCESSIBILITY_SPECS=1 bundle exec flatware rspec`.

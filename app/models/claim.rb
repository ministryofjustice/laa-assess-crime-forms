  ...
  def data_for_calculation
    {
      ...
      claimed_youth_court_fee_included: data['include_youth_court_fee_original'] || data['include_youth_court_fee'],
      plea_category: data['plea_category'],
      # :nocov:
      assessed_youth_court_fee_included: data['youth_court_fee_adjustment_comment']&.blank?,
      # :nocov:
    }
  end
